...
class MultipleOrthonormalMatrixGenerationSystem:
    """
    MULTIPLEORTHONORMALMATRIXGENERATIONSYSTEM Orthonormal matrix generator
    ...
    def __init__(self,
                 ...
                 mode='normal'):
        super(MultipleOrthonormalMatrixGenerationSystem, self).__init__()
        self.dtype = dtype
