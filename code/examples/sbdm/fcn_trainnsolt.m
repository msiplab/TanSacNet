function [prm,hist,done] = fcn_trainnsolt(anet,snet,info,prm,exemplars,sigmaRange,nIters,learnRate,miniBatchSize,isVerbose,ckptFile,maxSeconds)
%FCN_TRAINNSOLT Train the NSOLT denoiser by denoising score matching
%
%   [prm,hist] = fcn_trainnsolt(anet,snet,info,prm,exemplars,sigmaRange,...
...
%
%   No projection step is needed: the NSOLT parameterisation keeps the
...
for it = it0+1:nIters
    ...
    [loss,grads] = dlfeval(@fcn_nsoltloss,anet,snet,info,prm,v,x,sigma);
