classdef lsunInitialRotation1dLayerTestCase < matlab.unittest.TestCase
    %LSUNINITIALROTATION1DLAYERTESTCASE
    %
    ...
    methods (TestClassTeardown)
        function finalCheck(~)
            ...
            layer = lsunInitialRotation1dLayer(...
                'Stride',2,...
                'NumberOfBlocks',8);
    ...
    methods (Test)
        ...
        function testPredict(testCase, ...
            ...
            W0 = repmat(eye(pt,datatype),[1 1 nblks]);
            U0 = repmat(eye(pb,datatype),[1 1 nblks]);
        ...
        function testPredictWithDeviceAndDType(testCase, ...
            ...
            pt = ceil(nChsTotal/2);
            pb = floor(nChsTotal/2);
            W0 = repmat(eye(pt,datatype),[1 1 nblks_]);
            U0 = repmat(eye(pb,datatype),[1 1 nblks_]);
        ...
        function testBackwardWithDeviceAndDType(testCase, ...
            ...
            % dLdX = dZdX x dLdZ
            if nAnglesH == 0
                W0T = repmat(mus_,[1 1 nblks_]);
                U0T = repmat(mus_,[1 1 nblks_]);
            else
                W0T = permute(genW.step(anglesW,mus_,0),[2 1 3]);
                U0T = permute(genU.step(anglesU,mus_,0),[2 1 3]);
            end
