classdef lsunAnalysis3dNetwork < dlnetwork
    %LSUNANALYSIS3dNETWORK
    %
    ...
    methods
        function obj = lsunAnalysis3dNetwork(varargin)
        ...
        function adj = transpose(obj)
            ...
            %         if isa(alayer,'tansacnet.lsun.lsunInitialRotation3dLayer')
    ...
    methods (Hidden=false)
        function dlnet = dlnetwork(obj)
            ...
            if all(mod(stride,2)) % Check if stride is even
            ...
            if any(mod(nBlocks,1))
                error('[%d %d %d] : Input size should be multiple of stride.')
            end
            ...
            lsundlnet = addLayers(lsundlnet,[image3dInputLayer(inputSize,'Name',[prefix 'Image input'],'Normalization','none'), ...
