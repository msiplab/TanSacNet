classdef lsunChannelSeparation3dLayer < nnet.layer.Layer %#codegen
    %NSOLTCHANNELSEPARATION2DLAYER
    %
    %   １コンポーネント入力(nComponents=1のみサポート):
    %      nChsTotal x nRows x nCols x nLays x nSample
    %
    ...
    methods
        function layer = lsunChannelSeparation3dLayer(varargin)
