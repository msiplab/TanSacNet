classdef lsunBlockIdct3dLayer < nnet.layer.Layer %#codegen
    ...
    methods
        function layer = lsunBlockIdct3dLayer(varargin)
            ...
            % Coefficient order in each group: depth fastest, vertical
            % slowest (Byxz), as getMatrixE0_ in the test case
    ...
    methods (Static, Access = private)
        ...
        function C = permuteRowsYXZ_(C,decV,decH,decD)
            ...
            % kron (vertical fastest) to that of getMatrixE0_ in the test
            % case (depth fastest, vertical slowest)
