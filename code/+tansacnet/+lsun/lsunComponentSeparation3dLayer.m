classdef lsunComponentSeparation3dLayer < nnet.layer.Layer %#codegen
    %LSUNCOMPONENTSEPARATION3DLAYER
    %
    ...
    methods
        function layer = lsunComponentSeparation3dLayer(numComponents,varargin)
        ...
        function varargout = predict(layer, X)
           ...
           nChsPerCmp = size(X,4)/numOutputs;
