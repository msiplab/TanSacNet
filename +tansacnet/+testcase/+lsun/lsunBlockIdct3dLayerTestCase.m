classdef lsunBlockIdct3dLayerTestCase < matlab.unittest.TestCase
    ...
    methods (TestClassTeardown)
        function finalCheck(~)
            ...
            layer = lsunBlockIdct3dLayer(...
                'Stride',[2 2 2]);
            checkLayer(layer,[8 4 4 4],...
    ...
    methods (Test)
        ...
        function testBackward(testCase, ...
            ...
            expctddLdX = zeros(ndecs,nrows,ncols,nlays,nSamples,datatype);
