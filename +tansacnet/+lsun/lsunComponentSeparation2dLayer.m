classdef lsunComponentSeparation2dLayer < nnet.layer.Layer %#codegen
    %LSUNCOMPONENTSEPARATION2DLAYER
    %
    ...
    methods
        function layer = lsunComponentSeparation2dLayer(numComponents,varargin)
