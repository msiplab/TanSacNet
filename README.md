...
## Package structure
        ...
        │   │   ├── setup.py
        │   │   └── torch_tansacnet
        │   │       ├── lsunAnalysis2dNetwork.py
        │   │       ├── lsunSynthesis2dNetwork.py
        │   │       ...
        │   ├── examples
        │   │   ├── lsun
        │   │   │   ├── main_lsun.mlx
        ...
        │   │   │   ...
        │   │   ├── pidmd
        │   │   │   ├── main_pidmdvialsun.mlx
        │   │   │   ...
        │   │   └── tddmd
        │   │       ├── main_tddmdburgers_lsun.mlx
        │   │       ...
        │   ├── mexcodes      (generated by mybuild)
        │   ├── mybuild.m
        │   ├── mytest.m
        │   └── setpath.m
        ├── data
...
4. Run the unit tests if you want to verify the installation. 
   All test cases under the package '+tansacnet/+testcase' are executed by

        >> mytest

   A single test case can be specified by its class name, such as

        >> mytest('tansacnet.testcase.lsun.lsunBlockDct2dLayerTestCase')

5. Several example codes are found under the second layer directory 
